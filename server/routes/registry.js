...
export const API_ROUTES = Object.freeze([
    ...
    { methods: ['GET'], match: exact('comments/visibility'), handler: 'commentVisibility', auth: 'public', csrf: false },
...
export function validateApiRouteRegistry(routes = API_ROUTES, handlerNames = []) {
    ...
    for (const route of routes) {
        ...
        if (typeof route.csrf !== 'boolean' && route.csrf !== 'authenticated') {
