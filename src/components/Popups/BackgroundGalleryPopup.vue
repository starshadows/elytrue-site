...
import { DOWNLOAD_IMAGE_GROUPS } from '../../config/assets'
...
<template>
  <div>
    ...
    <section
      v-for="group in DOWNLOAD_IMAGE_GROUPS"
      :key="group.id"
      class="backgroundDownloadGroup"
    ...
    >
      ...
      <template v-for="background in group.images" :key="background.id">
        <img
          loading="lazy"
          decoding="async"
          ...
          @load="loaded"
        />
        <p class="backgroundDownloadMeta">
