import { html2elmnt } from "../.."

export function addPullDownRefresh(el: HTMLElement, refreshAction: () => Promise<any> | unknown, enabled?: () => boolean) {
    ...
    function touchendHandler() {
        ...
        const circleHeight = (pullRefreshEl.querySelector('.loadingCircle') as HTMLDivElement).offsetHeight * 1.75
    ...
    if ('prepend' in HTMLElement.prototype) {
        ...
        console.warn('Your browser does not support `HTMLElement.prepend`, pull down refresh will not work')
    }
}
